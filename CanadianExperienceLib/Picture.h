...
private:
    ...
    /// Pointer to the machine drawable we are editing
...
public:
    ...
    */
    ...
    /**
     * Return a pointer to the machine drawable we are editing
     * @return mMachine Pointer to the machine drawable we are editing
     */
    std::shared_ptr<MachineDrawable> GetMachineDrawable() { return mMachine; }

    /**
     * Set a pointer to the machine drawable we want to be editing
     * @param machine New pointer to the machine drawable we want to edit
     */
    void SetMachineDrawable(std::shared_ptr<MachineDrawable> machine) { mMachine = machine; }
};
